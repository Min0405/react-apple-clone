...
function Airpods() {
  ...
  const scrollProgress = () => {
     ...
     const scrollLen = Math.ceil(scrollpx / winHeightPx * 100 / 1.9);
      ...
      <div className="Airpods-sticky-container">
        <header className="airpods-sticky">
          <div className="airpods-slide-container">
            ...
            <div className="airpods-slide1"><img className="img" src={`https://www.apple.com/105/media/us/airpods-3rd-generation/2021/3c0b27aa-a5fe-4365-a9ae-83c28d10fa21/anim/battery/large/${scrolled.toString().padStart(4, '0')}.jpg`} alt="phot" /></div>
